const buildCardElements = portfolioItem => {
  ...
  card__popupWebsiteIconSVG.setAttribute("width", "24");
  card__popupWebsiteIconSVG.setAttribute("height", "24");
  ...
  //builds Git SVG icon
  card__popupGitIconSVG.setAttribute("width", "24");
  card__popupGitIconSVG.setAttribute("height", "24");
...
export const assembleCard = portfolioItem => {
